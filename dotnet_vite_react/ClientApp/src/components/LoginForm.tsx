export default function SignInForm({setFast}: {setFast:any}) {
    return (
        <>
            <div className='flex flex-col gap-2' id='text-box'>
                <svg
                ...
                <div id='text-wrap'>
                    ...
                    <div className='text text2'>
                        Let’s begin the adventure with us!
                    </div>
                </div>
                <form id='login' className='flex flex-col peer'>
                    <label
                        htmlFor='emailInput'
                        style={{
                            display: 'block',
                    ...
                    <div className='flex flex-col'>
                        ...
                        ></input>
                        <p className='text-base invisible peer-invalid:visible text-red-600 text-sm'>
                ...
                <button
                    form='text-box'
                    type='submit'
                    className='bg-blue-600 text-lg p-2 rounded peer-invalid:pointer-events-none peer-invalid:opacity-65'
                >
                    Login
                </button>
                <div onClick={(e)=>{
                    console.log(e)
                    setFast((state : boolean) => !state)
                }}>Dont' have account? Click here</div>
            </div>
        </>
    );
}
